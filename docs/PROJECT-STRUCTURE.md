...
build-bsp-image.sh             Debian BSP packed-image adapter
...
- `build-bsp-image.sh` owns BSP packed images that combine Armbian-built BSP packages with a distro rootfs.
