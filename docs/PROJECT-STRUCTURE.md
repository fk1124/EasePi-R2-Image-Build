...
build-rootfs-image.sh          Alpine/Fedora/Arch/Kali BSP packed-image adapter
build-alpine-image.sh          Alpine compatibility wrapper
...
- `build-rootfs-image.sh` owns Alpine/Fedora/Arch Linux ARM/Kali ARM BSP packed images.
